			...
			<ul id="transaction" class="nav-content collapse " data-bs-parent="#sidebar-nav">
				<li>
					<a href="/admin/transactions/pending">
						<i class="bi bi-circle"></i><span>Pending Transaction</span>
					</a>
				</li>
				<li>
					<a href="/admin/transactions/terminated">
						<i class="bi bi-circle"></i><span>Accepted Transaction</span>
					</a>
				</li>
				<li>
					<a href="/admin/transactions/onhold">
						<i class="bi bi-circle"></i><span>On Hold Transaction</span>
					</a>
				</li>
				<li>
					<a href="/admin/transactions/Canceled">
						<i class="bi bi-circle"></i><span>Cancelled Transaction</span>
					</a>
				</li>
			</ul>
		</li>
			...
			<ul id="phone" class="nav-content collapse " data-bs-parent="#sidebar-nav">
				<li>
					<a href="/admin/phones/pending">
						<i class="bi bi-circle"></i><span>Pending Phone</span>
					</a>
				</li>
				<li>
					<a href="/admin/phones/terminated">
						<i class="bi bi-circle"></i><span>Accepted Phone</span>
					</a>
				</li>
				<li>
					<a href="/admin/phones/onhold">
						<i class="bi bi-circle"></i><span>On Hold Phone</span>
					</a>
				</li>
				<li>
					<a href="/admin/phones/Canceled">
						<i class="bi bi-circle"></i><span>Cancelled Phone</span>
					</a>
				</li>
			</ul>
		</li>
